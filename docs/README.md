...
| 05 | [性能优化实战篇](./05-性能优化实战篇.md) | v0.5→v0.9 优化之路：Profiler、并行、批量sgemm、R-SWA | ~30 min |

**总计约 2.5 小时**，从零基础到能读懂大模型推理引擎的 C 代码。
...
```
零基础 ──→ 01 Transformer基础 ──→ 02 MoE混合专家 ──→ 03 推理引擎实战 ──→ 04 完整推理流程 ──→ 05 性能优化实战
           (理解骨架)             (理解创新)          (理解实现)           (理解全貌)           (理解极限)
```
